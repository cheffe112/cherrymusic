...
(function (root, factory) {
	...
	$.jPlayer.emulateStatus = "src readyState networkState currentTime duration paused ended playbackRate tempo";
...
*/
		...
		_addHtmlEventListeners: function(mediaElement, entity) {
			...
			// TODO remove this
			mediaElement.addEventListener("tempochange", function() {
				if(entity.gate) {
					console.log("eventListener tempochange: "+mediaElement);
					self.options.tempo = mediaElement.bpm;
					//self._updateTempo();
					self._trigger($.jPlayer.event.tempochange);
				}
			}, false);
		...
		tempoInput: function(tempo) {
			console.log("_updateTempo: "+tempo.target.value);
			this._setOption("tempo", tempo.target.value);
			this._updatePlaybackRate();
		},
		...
		_setOption: function(key, value) {
			...
			switch(key) {
				...
				case "maxPlaybackRate" :
					...
					break;
				case "tempo" :
					// TODO add min/max values and limit input
					this.options[key] = value;
					if(this.html.used) {
						this._html_setProperty('tempo', value);
					}
