...
*/
		...
		bpm: function(bpm) {
			this._setOption("bpm", bpm);
			this.tempoInput(userOptions.misc.tempo);
		},
		...
		tempoInput: function(tempo) {
			if(tempo.target) {
				var targetTempo = tempo.target.value;
			} else {
				var targetTempo = tempo;
			}
			userOptions.misc.tempo = targetTempo;
			if (userOptions.misc.automatic_tempo) {
				if (targetTempo > 0 && this.options.bpm > 0) {
					if (userOptions.misc.automatic_tempo_unit == 'mpm') {
						targetTempo = targetTempo * 4;
					}
					var playbackRate = targetTempo / this.options.bpm;
		...
		_setOption: function(key, value) {
			...
			switch(key) {
				...
				case "bpm" :
					this.options[key] = value;
					if(this.html.used) {
						this._html_setProperty('bpm', value);
					}
					break;
				case "fullScreen" :
